...
parse.add_argument("--resnet_model", default='resnet50', help="The variant of resnet.")
parse.add_argument("--num_classes", type=int, default=21, help="Number of classes.")
parse.add_argument("--learning_rate", default=1e-3, help="Learning rate for training")
parse.add_argument("--num_epochs", type=int, default=20, help="Epochs of train")
parse.add_argument("--batch_size", type=int, default=4, help="Batch size for training")
